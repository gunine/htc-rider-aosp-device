...
adb pull /system/lib/hw/gps.rider.so ../../../vendor/htc/$DEVICE/proprietary
...
adb pull /system/lib/hw/sensors.rider.so ../../../vendor/htc/$DEVICE/proprietary
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/htc/__DEVICE__/proprietary/gps.rider.so:/system/lib/hw/gps.rider.so \\
    ...
    vendor/htc/__DEVICE__/proprietary/sensors.rider.so:/system/lib/hw/sensors.rider.so
EOF
